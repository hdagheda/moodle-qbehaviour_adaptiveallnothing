...
namespace qbehaviour_adaptiveallnothing;
...
final class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    /**
     * Get does not contain penalty info expectation
     */
    ...
    /**
     * Get contains total penalty expectation
     *
     * @param float $penalty Penalty
     */
    ...
    /**
     * Get does not contain total penalty expectation(
     */
    ...
    /**
     * Get contains disregarded info expectation
     */
    ...
    /**
     * Get does not contain desrearded info expectation
     */
    ...
    public function test_adaptiveallnothing_multichoice(): void {
        ...
        $this->start_attempt_at_question($mc, 'adaptiveallnothing', 3);
    ...
    public function test_adaptiveallnothing_multichoice2(): void {

        // Create a multiple choice, multiple response question.
        $mc = \test_question_maker::make_a_multichoice_multi_question();
        $mc->penalty = 0.3333333;
        $mc->shuffleanswers = 0;
        $this->start_attempt_at_question($mc, 'adaptiveallnothing', 2);
    ...
    public function test_adaptiveallnothing_shortanswer_partially_right(): void {
        ...
        $this->start_attempt_at_question($sa, 'adaptiveallnothing');
        ...
        // Verify.
        $this->check_current_state(question_state::$complete);
        $this->check_current_mark(0.333334);
        $this->render();
    ...
    public function test_adaptiveallnothing_shortanswer_wrong_right_wrong(): void {
        ...
        // Create a short answer question.
        $sa = \test_question_maker::make_question('shortanswer');
        $this->start_attempt_at_question($sa, 'adaptiveallnothing', 6);
    ...
    /**
     * Test adaptiveallnothing shortanswer try to submit blank
     */
    public function test_adaptiveallnothing_shortanswer_try_to_submit_blank(): void {
    ...
    public function test_adaptiveallnothing_numerical_invalid(): void {
        ...
        $numq->penalty = 0.1;
        $this->start_attempt_at_question($numq, 'adaptiveallnothing');
    ...
    public function test_adaptiveallnothing_multianswer(): void {
        ...
        $choices = ['0' => 'Bow-wow', '1' => 'Wiggly worm', '2' => 'Pussy-cat'];

        $this->start_attempt_at_question($q, 'adaptiveallnothing', 12);
